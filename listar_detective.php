<?php
    ...
    $consulta = "SELECT id,rut,nombre,apellidos,telefono FROM detective;";
...
<head>
    ...
    <body>
        <h1 class="h1_1">LISTA DE DETECTIVES</h1>
        <nav class="menu">
            <ul>
                <div class="centrado">
                    <?php
                    ...
                    {
                        echo '<li> Rut: =>'.$registro['rut'].'<br> Nombre: => '.$registro['nombre'].' '.$registro['apellidos'].'<br> Teléfono => '.$registro['telefono'].'<br> ';
